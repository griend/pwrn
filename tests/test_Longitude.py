...
from pwrn.base import Longitude
from pwrn.error import LongitudeError
...
class TestLongitude(unittest.TestCase):
    def test_init_0(self):
        ...
        self.assertEqual(long.get_degrees(), 0.0)
        self.assertEqual(str(long), "000 00.0 E")

    def test_init_52E(self):
        long = Longitude(52.0)

        self.assertEqual(long.get_degrees(), 52.0)
    ...
    def test_init_52_15E(self):
        ...
        self.assertEqual(long.get_degrees(), 52.25)
    ...
    def test_init_180E(self):
        ...
        self.assertEqual(long.get_degrees(), 180.0)
        self.assertEqual(str(long), "180 00.0 E")

    def test_init_181E(self):
        with self.assertRaises(LongitudeError):
